...
namespace ClientObserver.ViewModels.ServerPage
{
    public class MqttDisplayViewModel : INotifyPropertyChanged
    {
        ...
        // Constructor
        public MqttDisplayViewModel(MqttClientService mqttClientService)
        {
